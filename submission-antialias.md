...
| mirror_primitives_colordebug.ini | ![](expected_outputs/antialias/required/mirror_primitives_colordebug.png) | ![Place mirror_primitives_colordebug.png in student_outputs/antialias/required folder](student_outputs/antialias/required/mirror_primitives_colordebug.png) |
...
| moire_checkerboard_colordebug_bilinear.ini | ![](expected_outputs/antialias/required/moire_checkerboard_colordebug_bilinear.png) | ![Place moire_checkerboard_colordebug_bilinear.png in student_outputs/antialias/required folder](student_outputs/antialias/required/moire_checkerboard_colordebug_bilinear.png) |
...
| moire_checkerboard_colordebug_trilinear.ini | ![](expected_outputs/antialias/required/moire_checkerboard_colordebug_trilinear.png) | ![Place moire_checkerboard_colordebug_trilinear.png in student_outputs/antialias/required folder](student_outputs/antialias/required/moire_checkerboard_colordebug_trilinear.png) |
